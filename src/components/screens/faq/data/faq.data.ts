export const tips = [
	...
	{
		title: ' Куда включить начисление ЖКУ нежилым помещениям?',
		text: 'Начисление ЖКУ и капремонта необходимо включить в общие суммы начислений в разрезе услуг (Блок "Начисления ЖКУ за отчетный период"). Также необходимо указать площадь жилых помещений, которым осуществляется начисление ЖКУ и капремонта (в блоке "Параметры организации". Тогда алгоритм рассчитает начисление нежилым пропорционально их площади и включит их в те поля, которые необходимо, а также исключит из значения тех полей итогового отчета, где их быть не должно.'
	},
	{
