...
export const sectionTwoNames: ISectionNames = {
	...
	32: 'Начислено взносов на капитальный ремонт',
	33: 'Оплачено взносов на капитальный ремонт',
	34: 'Фактические расходы на проведение капитального ремонта',
	35: 'в том числе бюджетное финансирование'
}
